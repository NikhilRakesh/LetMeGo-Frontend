  ...
  return (
    <div className='m-5'>
      ...
      <div className='flex flex-col gap-2 py-6'>
        <p className='text-2xl font-medium font-poppins'>Create Your Account!</p>
        <p className='text-xs text-gray-400'>Hello , welcome back to our account !</p>
      </div>
      <div className='flex border border-gray-400  gap-2 p-2 rounded-full'>
        <div className='bg-[#27ABE2] w-6/12 rounded-full text-center text-white py-2'>Email</div>
